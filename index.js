...
// ID Grup dan Topic Target
const GROUP_CHAT_ID = -1003895327942;
const MESSAGE_THREAD_ID = 170270; // ID Topic / Thread spesifik tempat pemesanan diizinkan

// Variabel untuk menyimpan data Bartender yang sedang aktif
let activeBartender = {
    id: null,
    name: null,
    lastActionTime: 0
...
// Variabel antrean dan tanggal hari ini
let orderCounter = 1;
let lastResetDate = new Date().toDateString();

// Database antrean pesanan aktif
let activeQueue = [];

// State untuk menyimpan proses catatan/alasan per user bartender
let bartenderState = {};

// Variabel untuk Timer Auto-Stop Bartender (Idle Timeout - 5 Menit)
const IDLE_TIMEOUT_MS = 300000; 

async function checkAndResetBartender(botInstance) {
    if (activeBartender.id === null) return;
    
    // Cek apakah sudah lebih dari 5 menit tidak ada aksi
...
// Daftar Menu Bar RP lengkap dengan detail proses unik per minuman
const barMenu = [
    {
...
function checkDailyReset() {
    ...
    if (currentDate !== lastResetDate) {
        ...
        console.log('🔄 Hari baru terdeteksi: Nomor tiket antrean & data di-reset ke 001.');
    }
}
...
// ==========================================
// ADAPTOR CLOUDFLARE WORKERS (FIX 404 & WEBHOOK)
// ==========================================
export default {
    async fetch(request, env, ctx) {
        ...
        return new Response('Bar Master Bot is active and running!', { status: 200 });
    }
};
